                           ...
                           {/*  <div className="d-flex align-items-center justify-between gap-5 px-4 py-2 border-b">
                                ...
                                <div className="shop-widget" >
                                    ...
                                    {ratingsToggle ?
                                        ...
                                        <i class="fa fa-chevron-up" style={{ fontSize: "16px" ,lineHeight: "inherit" }}></i> :
                                        <i class="fa fa-chevron-down" style={{ fontSize: "16px" ,lineHeight: "inherit" }}></i>
                                    ...
                                    <RadioGroup
                                        aria-label="ratings-radio-buttons-group"
                                                ...
                                                <ul className="shop-widget-list shop-widget-scroll">
                                                    {categories.map((category, i) => (
                                                        ...
                                                        >
                                                            ...
                                                            <span className="shop-widget-number">({products.length})</span>
